...
{
    [TestCaseOrderer("Features.Tests.PriorityOrderer", "Features.Tests")] //Passa o nome da classe possui a configuração de TestPriority, e depois o namespace dessa classe
    public class OrdemTestes
    {
        ...
        [Fact(DisplayName = "Teste 02"), TestPriority(500)] //Pode colocar um numero enorme para garantir que ele seja sempre o ultimo
        [Trait("Categoria", "Ordenacao Testes")]
        public void Teste02()
        {
            Teste2Chamado = true;
