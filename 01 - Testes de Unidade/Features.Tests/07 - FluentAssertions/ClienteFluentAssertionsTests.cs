...
namespace Features.Tests
{
    ...
    public class ClienteFluentAssertionsTests
    {
        ...
        readonly ITestOutputHelper _outputHelper; //Propriedade do xUnit, é um helper que ajuda a fazer um output de um texto 
        ...
        public void Cliente_NovoCliente_DeveEstarInvalido()
        {
            ...
            _outputHelper.WriteLine($"Foram encontrados {cliente.ValidationResult.Errors.Count} erros nessa validação");
        }
    }
}